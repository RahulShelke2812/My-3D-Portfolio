...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setLoading(true);
//F6oPOCWjZPT7Af5K8 - public key
//template_z11sfwe
//service_4mhnspj
    emailjs
      .send(
        // import.meta.env.service_4mhnspj,
        // import.meta.env.template_z11sfwe,
        'template_z11sfwe',
       'service_4mhnspj',
        {
          from_name: form.name,
          ...
          to_email: "rahulshelke@gmail.com",
          message: form.message,
        },
       'F6oPOCWjZPT7Af5K8'
        // import.meta.env.F6oPOCWjZPT7Af5K8
      )
      .then(
        () => {
          setLoading(false);
  ...
  return (
    ...
    >
      <motion.div
        ...
        // className='flex-[0.45] bg-black-100 p-5 rounded-2xl'
